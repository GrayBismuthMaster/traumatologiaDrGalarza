 ...
 * @author Dell
 */
public class EleccionArchivo extends javax.swing.JFrame {

    /**
     * Creates new form EleccionArchivo
     */
    public EleccionArchivo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        JFCImg.setCurrentDirectory(new java.io.File("C:\\Users\\Dell\\Pictures"));
        JFCImg.setDialogTitle("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EleccionArchivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EleccionArchivo().setVisible(true);
            }
        });
    }
